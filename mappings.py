use_case_dict = {
    ...
    "MCR ADV": {
        ...
        "status_crosswalk": {
            ...
            "E16-Unexpected screen  occured, Insurence Eligibility header not found - E16-Unexpected screen  occured, Insurence Eligibility header not found":"TechnicalException",
            "BE01-BE01-Non-HDX Payer - BE01-BE01-Non-HDX Payer":"Business Exception",
            "BE01-Special Characters Found error pop-up encountered. - BE01-Special Characters Found error pop-up encountered.":"Business Exception",
    ...
    "BD IS PRINTING": {
        "file_path": "M:/CPP-Data/Sutherland RPA/BD IS Printing/{year_str}",
        ...
        "name_format": "{file_path}/{year_str}{month_str}*BADDEBT*OUTBOUND.xlsx",
        "column_crosswalk": {
            "POLICYID": "Invoice Number",
            "RetrievalStatus": "Retrieval Status",
            "RetrievalDescription": "Retrieval Description",
